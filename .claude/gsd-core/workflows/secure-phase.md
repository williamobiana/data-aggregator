...
```
Agent(
  prompt="Read /home/user/workspace/lab/data-aggregator/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/workspace/lab/data-aggregator/.claude/gsd-core/templates/SECURITY.md`
