...
Reference full template: `/home/user/workspace/lab/data-aggregator/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/workspace/lab/data-aggregator/.claude/gsd-core/templates/state.md`.
