...
<required_reading>
Read `/home/user/workspace/lab/data-aggregator/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
