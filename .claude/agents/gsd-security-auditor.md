...
**Verification depth scales with `asvs_level`** (see @/home/user/workspace/lab/data-aggregator/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
