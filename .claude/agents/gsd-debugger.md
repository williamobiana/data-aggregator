...
<required_reading>
@/home/user/workspace/lab/data-aggregator/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/home/user/workspace/lab/data-aggregator/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/workspace/lab/data-aggregator/.claude
                  → checks /home/user/workspace/lab/data-aggregator/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/workspace/lab/data-aggregator/.claude/gsd-core
                  → writes to /home/user/workspace/lab/data-aggregator/.claude/gsd-core/hooks/
...
@/home/user/workspace/lab/data-aggregator/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/home/user/workspace/lab/data-aggregator/.claude/gsd-core/references/common-bug-patterns.md
