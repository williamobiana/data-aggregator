...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/workspace/lab/data-aggregator/.claude/.gsd-surface.json`
(sibling to `/home/user/workspace/lab/data-aggregator/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/workspace/lab/data-aggregator/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/workspace/lab/data-aggregator/.claude/skills`).
...
`/home/user/workspace/lab/data-aggregator/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/workspace/lab/data-aggregator/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/workspace/lab/data-aggregator/.claude/.gsd-surface.json`
Install profile marker: `/home/user/workspace/lab/data-aggregator/.claude/.gsd-profile`
Skill dirs: `/home/user/workspace/lab/data-aggregator/.claude/skills/gsd-*/`
Engine module: `/home/user/workspace/lab/data-aggregator/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/workspace/lab/data-aggregator/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
